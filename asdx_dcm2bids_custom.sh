...
subject_file=${study_path}/code/${study_id}_proc/${study_id}_dcm2bids_custom.csv
...
while IFS=, read -r subj_num ses_num scan_id ; do
	...
	config_file=${study_path}/code/${study_id}_proc/dcm2bids_json_files/dcm2bids_config_${study_id}_sub-${subj_num}_ses-0${ses_num}.json
