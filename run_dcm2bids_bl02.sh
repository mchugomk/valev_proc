...
subject_file=${study_path}/code/valev_proc/dcm2bids_bl02.csv
# config_file=${study_path}/code/valev_proc/dcm2bids_json_files/dcm2bids_config_${study_id}.json
config_file=${study_path}/code/valev_proc/dcm2bids_json_files/dcm2bids_config_${study_id}_bl02.json
echo $subject_file
{
read
